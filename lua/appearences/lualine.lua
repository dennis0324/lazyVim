...
colors.lualine = {
  yellow = colors.terminal.color3,
  cyan = colors.cyan,
  darkblue = colors.terminal.color4,
  green = colors.terminal.color10,
  orange = colors.orange,
  violet = colors.terminal.color5,
  magenta = colors.terminal.color13,
  blue = colors.terminal.color12,
  red = colors.terminal.color9,
