-- this plugin provides a way to add multiple cursors in Neovim, similar to what you find in modern text editors like VSCode.
--
return {
  {
    ...
    config = function()
      ...
      set({ "n", "x" }, "<leader>S", function()
        mc.matchSkipCursor(-1)
      end, { desc = "Skip cursor by matching word/selection above" })
